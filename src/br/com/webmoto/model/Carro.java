...
public class Carro {
	...
	private long id;
	public Carro(long id, String name, String brand, String color) {
		super();
		this.id = id;
		this.name = name;
		this.brand = brand;
	...
	public Carro(String name, String brand, String color) {
		super();
		this.name = name;
		this.brand = brand;
		this.color = color;
	...
	public String toString() {
		return "Carro [id=" + id + ", name=" + name + ", brand=" + brand + ", color=" + color + "]";
	}
